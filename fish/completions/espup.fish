...
complete -c espup -n "__fish_espup_using_subcommand completions" -s l -l log-level -d 'Verbosity level of the logs' -r -f -a "{debug\t'',info\t'',warn\t'',error\t''}"
complete -c espup -n "__fish_espup_using_subcommand completions" -s h -l help -d 'Print help'
complete -c espup -n "__fish_espup_using_subcommand install" -s d -l default-host -d 'Target triple of the host' -r -f -a "{x86_64-unknown-linux-gnu\t'',aarch64-unknown-linux-gnu\t'',x86_64-pc-windows-msvc\t'',x86_64-pc-windows-gnu\t'',x86_64-apple-darwin\t'',aarch64-apple-darwin\t''}"
...
complete -c espup -n "__fish_espup_using_subcommand install" -s l -l log-level -d 'Verbosity level of the logs' -r -f -a "{debug\t'',info\t'',warn\t'',error\t''}"
...
complete -c espup -n "__fish_espup_using_subcommand uninstall" -s l -l log-level -d 'Verbosity level of the logs' -r -f -a "{debug\t'',info\t'',warn\t'',error\t''}"
...
complete -c espup -n "__fish_espup_using_subcommand update" -s d -l default-host -d 'Target triple of the host' -r -f -a "{x86_64-unknown-linux-gnu\t'',aarch64-unknown-linux-gnu\t'',x86_64-pc-windows-msvc\t'',x86_64-pc-windows-gnu\t'',x86_64-apple-darwin\t'',aarch64-apple-darwin\t''}"
...
complete -c espup -n "__fish_espup_using_subcommand update" -s l -l log-level -d 'Verbosity level of the logs' -r -f -a "{debug\t'',info\t'',warn\t'',error\t''}"
